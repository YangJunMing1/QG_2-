...
public:
	...
	enum class ShowMode { WoodCrate, FireAnim ,RoAnim};
...
private:
	...
	std::vector<ComPtr<ID3D11ShaderResourceView>> m_pTestAnims;

	ComPtr<ID3D11ShaderResourceView> m_pFlareAlpha;
	ComPtr<ID3D11ShaderResourceView> m_pFlare;
	ComPtr<ID3D11ShaderResourceView> m_pMix;			    // 旋转动画纹理
	ComPtr<ID3D11ShaderResourceView> m_p1;
	ComPtr<ID3D11ShaderResourceView> m_p2;
